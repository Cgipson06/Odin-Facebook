...
* Users index page lists all users and buttons for sending Friend Requests to those who are not already friends or have a pending request(Need to alter to only show friendable people)

* Sign in with the Omniauth Gem to allow login via Facebook.(complete)
